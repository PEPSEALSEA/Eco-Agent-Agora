  ...
  const seedScenarios = async () => {
    ...
    const sampleScenarios = [
      ...
      },
      {
        ...
        target_group: "professional",
        characters: [
          { name: "ลุงบุญส่ง", role: "ผู้นำกลุ่มเกษตรกร", agenda: "ปกป้องที่ดินทำกินของบรรพบุรุษและต้องการความมั่นใจเรื่องรายได้", personality: "รักบ้านเกิด ช่างสังเกต และไม่ไว้ใจคนเมือง" },
          { name: "ป้าสมใจ", role: "ตัวแทนกลุ่มแม่บ้าน", agenda: "ต้องการให้คนในชุมชนมีงานทำและมีสวัสดิการที่ดีขึ้น", personality: "ใจดีแต่รอบคอบ เน้นเรื่องความเป็นอยู่ของครอบครัว" }
        ]
      }
    ];
